...
/**
 * Data-Centric PDF Generation Engine (Fixed for ESM)
 * 
 * Generates a professional Business Report with explicit 
 * error trapping and robust plugin initialization.
 */
export const generatePDFReport = (data, logs) => {
  try {
    ...
    console.log('PDF: Starting generation engine...');
    ...
    autoTable(doc, {
      ...
      body: [
        ['PATIENT_IDENTITY', 'Full Name', `${patient.first_name || 'N/A'} ${patient.last_name || 'N/A'}`, 'VERIFIED'],
    ...
    throw error; // Rethrow to main.js handler
  }
};
